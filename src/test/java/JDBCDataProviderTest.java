...
public class JDBCDataProviderTest extends EntityTest {
    private static final Logger log = LogManager.getLogger(JDBCDataProvider.class.getName());
    protected IDataProvider provider = new JDBCDataProvider();
